...
const sections = [
  ['About Sagawa', 'Sagawa is an independent informational, educational, awareness, and technology case-study application created by Kyaw San Lin. It may provide news, MYR/MMK exchange-rate information, community and service information, user accounts, email or phone verification, Google Sign-In, notifications, and support features.'],
  ['Information we may collect', 'Depending on how you use Sagawa, we may process account information such as your name, email address or phone number, account identifier, profile information, profile image, information you submit, limited technical information, server logs, and notification tokens.'],
